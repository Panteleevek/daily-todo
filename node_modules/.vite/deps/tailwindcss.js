...
var g2 = class {
  ...
  resolveWith(e, r, i = []) {
    ...
    for (let u2 of i) {
      ...
      a && (a.options & 1 ? s2[u2] = a.value : s2[u2] = this.#t(o));
    }
    let l4 = this.values.get(t);
    return l4.options & 1 ? [l4.value, s2] : [this.#t(t), s2];
  }
  namespace(e) {
  ...
  for (let [g3, h3] of p3) {
    ...
    }
    {
      ...
      if (w2 !== -1) {
        ...
        let x = c2 === null || y2.modifier?.kind === "arbitrary" ? null : `${h3}/${c2}`;
...
function Vt(t) {
      ...
      return (b2) => {
        ...
        if (b2.value) if (b2.value.kind === "arbitrary") {
          ...
          if (N2 === null && k2 && u2.handleNegativeBareValue) {
            if (N2 = u2.handleNegativeBareValue(b2.value), !N2?.includes("/") && b2.modifier) return;
            if (N2 !== null) return u2.handle(N2);
          }
          if (N2 === null && u2.handleBareValue && (N2 = u2.handleBareValue(b2.value), !N2?.includes("/") && b2.modifier)) return;
        }
        else {
          if (b2.modifier) return;
  ...
  e("bg-auto", [["background-size", "auto"]]), e("bg-cover", [["background-size", "cover"]]), e("bg-contain", [["background-size", "contain"]]), e("bg-fixed", [["background-attachment", "fixed"]]), e("bg-local", [["background-attachment", "local"]]), e("bg-scroll", [["background-attachment", "scroll"]]), e("bg-center", [["background-position", "center"]]), e("bg-top", [["background-position", "top"]]), e("bg-right-top", [["background-position", "right top"]]), e("bg-right", [["background-position", "right"]]), e("bg-right-bottom", [["background-position", "right bottom"]]), e("bg-bottom", [["background-position", "bottom"]]), e("bg-left-bottom", [["background-position", "left bottom"]]), e("bg-left", [["background-position", "left"]]), e("bg-left-top", [["background-position", "left top"]]), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
  {
    let m = function(N2) {
      let K2 = "in oklab";
      if (N2?.kind === "named") switch (N2.value) {
        case "longer":
        case "shorter":
        case "increasing":
        case "decreasing":
      ...
      else N2?.kind === "arbitrary" && (K2 = N2.value);
      return K2;
        ...
        (le(S2, (E2, { replaceWith: P2 }) => {
          if (E2.kind === "function") {
            if (E2.value === "--value") {
              f3 = true;
              let i = $t(c2, E2, n);
              return i ? (p3 = true, i.ratio ? w2 = true : y2.set(v, x), P2(i.nodes), 1) : (f3 ||= false, V2([]), 2);
            } else if (E2.value === "--modifier") {
              if (d2 === null) return V2([]), 1;
              g3 = true;
              let i = $t(d2, E2, n);
              return i ? (h3 = true, P2(i.nodes), 1) : (g3 ||= false, V2([]), 2);
            }
          }
        }) ?? 0) === 0 && (v.value = B2(S2));
  ...
  return function(o, s2) {
    ...
    let d2 = (() => {
      ...
      if (h3 !== null && typeof h3 == "object" && !Array.isArray(h3)) {
        ...
        for (let w2 in p3) w2 !== "__CSS_VALUES__" && (h3?.__CSS_VALUES__?.[w2] & 4 && Bt(y2, w2.split("-")) !== void 0 || (y2[c(w2)] = p3[w2]));
        return y2;
      }
...
function Gr(t, r) {
  ...
  return r[r.length - 1] === "DEFAULT" ? [d2?.DEFAULT ?? null, f3.DEFAULT ?? 0] : "DEFAULT" in d2 && Object.keys(d2).length === 1 ? [d2.DEFAULT, f3.DEFAULT ?? 0] : (d2.__CSS_VALUES__ = f3, [d2, f3]);
}
function Bt(t, r) {
...
function Ze({ designSystem: t, ast: r, resolvedConfig: n, featuresRef: e, referenceMode: o }) {
  let s2 = { addBase(a) {
    ...
    function f3(g3, h3, y2) {
      let w2 = c2(g3, { modifier: h3?.value ?? null });
      return or(w2, y2);
    }
    let p3 = Object.keys(d2?.values ?? {});
    t.variants.group(() => {
      t.variants.functional(a, (g3, h3) => {
        if (!h3.value) {
          if (d2?.values && "DEFAULT" in d2.values) {
        ...
        else if (h3.value.kind === "named" && d2?.values) {
      ...
      let y2 = g3.value ? g3.value.value : "DEFAULT", w2 = h3.value ? h3.value.value : "DEFAULT", v = d2?.values?.[y2] ?? y2, x = d2?.values?.[w2] ?? w2;
      if (d2 && typeof d2.sort == "function") return d2.sort({ value: v, modifier: g3.modifier?.value ?? null }, { value: x, modifier: h3.modifier?.value ?? null });
    ...
    let d2 = c2?.type ? Array.isArray(c2?.type) ? c2.type : [c2.type] : ["any"];
    for (let [p3, g3] of Object.entries(a)) {
      let h3 = function({ negative: y2 }) {
        return (w2) => {
          if (w2.value?.kind === "arbitrary" && d2.length > 0 && !d2.includes("any") && (w2.value.dataType && !d2.includes(w2.value.dataType) || !w2.value.dataType && !pe(w2.value.value, d2))) return;
          let v = d2.includes("color"), x = null, V2 = false;
          {
            let E2 = c2?.values ?? {};
            v && (E2 = Object.assign({ inherit: "inherit", transparent: "transparent", current: "currentColor" }, E2)), w2.value ? w2.value.kind === "arbitrary" ? x = w2.value.value : w2.value.fraction && E2[w2.value.fraction] ? (x = E2[w2.value.fraction], V2 = true) : E2[w2.value.value] ? x = E2[w2.value.value] : E2.__BARE_VALUE__ && (x = E2.__BARE_VALUE__(w2.value) ?? null, V2 = (w2.value.fraction !== null && x?.includes("/")) ?? false) : x = E2.DEFAULT ?? null;
          }
          if (x === null) return;
          let S2;
          {
            let E2 = c2?.modifiers ?? null;
            w2.modifier ? E2 === "any" || w2.modifier.kind === "arbitrary" ? S2 = w2.modifier.value : E2?.[w2.modifier.value] ? S2 = E2[w2.modifier.value] : v && !Number.isNaN(Number(w2.modifier.value)) ? S2 = `${w2.modifier.value}%` : S2 = null : S2 = null;
          }
          if (w2.modifier && S2 === null && !V2) return w2.value?.kind === "arbitrary" ? null : void 0;
      ...
      c2?.supportsNegativeValues && t.utilities.functional(`-${p3}`, h3({ negative: true }), { types: d2 }), t.utilities.functional(p3, h3({ negative: false }), { types: d2 }), t.utilities.suggest(p3, () => {
        let y2 = c2?.values ?? {}, w2 = new Set(Object.keys(y2));
        w2.delete("__BARE_VALUE__"), w2.has("DEFAULT") && (w2.delete("DEFAULT"), w2.add(null));
        let v = c2?.modifiers ?? {}, x = v === "any" ? [] : Object.keys(v);
        return [{ supportsNegative: c2?.supportsNegativeValues ?? false, values: Array.from(w2), modifiers: x }];
      });
    }
  }, addComponents(a, c2) {
...
function fn(t) {
  ...
  for (let s2 of t.configs) {
    ...
    for (let d2 in c2) t.extend[d2] ??= [], t.extend[d2].push(c2[d2]);
  }
...
function dr(t, r) {
  ...
  if (Object.keys(n).length > 0) {
    let s2 = r.variants.get("aria"), a = s2?.applyFn, c2 = s2?.compounds;
    r.variants.functional("aria", (d2, f3) => {
      let p3 = f3.value;
      return p3 && p3.kind === "named" && p3.value in n ? a?.(d2, { ...f3, value: { kind: "arbitrary", value: n[p3.value] } }) : a?.(d2, f3);
    }, { compounds: c2 });
  }
  if (Object.keys(e).length > 0) {
    let s2 = r.variants.get("supports"), a = s2?.applyFn, c2 = s2?.compounds;
    r.variants.functional("supports", (d2, f3) => {
      let p3 = f3.value;
      return p3 && p3.kind === "named" && p3.value in e ? a?.(d2, { ...f3, value: { kind: "arbitrary", value: e[p3.value] } }) : a?.(d2, f3);
    }, { compounds: c2 });
  }
  if (Object.keys(o).length > 0) {
    let s2 = r.variants.get("data"), a = s2?.applyFn, c2 = s2?.compounds;
    r.variants.functional("data", (d2, f3) => {
      let p3 = f3.value;
      return p3 && p3.kind === "named" && p3.value in o ? a?.(d2, { ...f3, value: { kind: "arbitrary", value: o[p3.value] } }) : a?.(d2, f3);
    }, { compounds: c2 });
  }
}
var pn = /^[a-z]+$/;
...
function pr({ designSystem: t, base: r, ast: n, globs: e, configs: o, pluginDetails: s2 }) {
  ...
  for (let { handler: v, reference: x } of f3.plugins) x ? (w2 ||= Ze({ ...h3, referenceMode: true }), v(w2)) : v(y2);
  ...
  if (!t.important && f3.important === true && (t.important = true), typeof f3.important == "string") {
    ...
    j2(n, (x, { replaceWith: V2, parent: S2 }) => {
      if (x.kind === "at-rule" && !(x.name !== "@tailwind" || x.params !== "utilities")) return S2?.kind === "rule" && S2.selector === v ? 2 : (V2(F2(v, [x])), 2);
    });
  }
...
async function yn(t, r = {}) {
  ...
  return { globs: o, root: s2, features: c2, build(h3) {
    if (c2 === 0) return t;
    if (!a) return p3 ??= te2(e), p3;
    let y2 = false, w2 = f3.size;
    for (let x of h3) n.invalidCandidates.has(x) || (f3.add(x), y2 ||= f3.size !== w2);
    if (!y2) return p3 ??= te2(e), p3;
    let v = Z2(f3, n, { onInvalidCandidate: d2 }).astNodes;
    return g3 === v.length ? (p3 ??= te2(e), p3) : (g3 = v.length, a.nodes = v, p3 = te2(e), p3);
  } };
}
